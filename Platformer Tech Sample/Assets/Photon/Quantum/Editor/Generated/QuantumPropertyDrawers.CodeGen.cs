...
namespace Quantum.Editor {
  ...
  [CustomPropertyDrawer(typeof(AssetRefCharacterHealthConfig))]
  public class AssetRefCharacterHealthConfigPropertyDrawer : PropertyDrawer {
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
      AssetRefDrawer.DrawAssetRefSelector(position, property, label, typeof(CharacterHealthConfigAsset));
    }
  }
